...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            //create a new JSON object and pass the response into it
            JSONObject baseJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            //Extract "features" JSONArray
            JSONArray jsonArrayResponse = baseJsonResponse.getJSONArray("features");
            ...
            for(int i=0;i<jsonArrayResponse.length();i++) {
                ...
                String location = ((JSONObject) properties).optString("place");
                Long time = properties.getLong("time");
                // Extract the value for the key called "url"
                String url = properties.getString("url");
                //Create Earthquake java object from mag, location and time
